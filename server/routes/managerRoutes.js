...
router.post(
  '/progress-reports/:id/review',
  verifyToken,
  restrictTo('manager'),
  managerController.approvestatusProgressReport
);
...
router.post('/project', verifyToken, restrictTo('manager'), managerController.createProject);
...
router.get('/progress', verifyToken, restrictTo('manager'), managerController.getProgress);
